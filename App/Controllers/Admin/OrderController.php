...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->_view->renderView('admin/orders/index', compact('orders', 'title', 'numRows'));
    }
    ...
    public function edit($vars)
    {
        ...
        $this->_view->renderView('admin/orders/edit', compact('user', 'order', 'title'));
    }
    ...
    public function delete($vars)
    {
        ...
        $title = 'Delete order';
        $order = Order::getById($id);
        $this->_view->renderView('admin/orders/delete', compact('title', 'order'));
    }
