...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $numRows = count($users);
        $this->_view->renderView('admin/users/index', compact('users', 'title', 'numRows'));
    }
    ...
    public function create()
    {
        ...
        $title = 'Create User';
        $roles = Role::index();
        $this->_view->renderView('admin/users/create', compact('title', 'roles'));
    ...
    public function edit($vars)
    {
        ...
        $roles = Role::index();
        $user = $user;
        $this->_view->renderView('admin/users/edit', compact('user', 'title', 'roles'));
    }
    ...
    public function delete($vars)
    {
        ...
        $title = 'Delete user';
        $user = user::getById($id);
        $this->_view->renderView('admin/users/delete', compact('title', 'user'));
    }
}